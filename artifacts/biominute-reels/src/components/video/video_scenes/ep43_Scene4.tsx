    ...
    >
      ...
      <div className="absolute top-[210px] z-10 w-[90%]">
        ...
        >
          ...
          >
            <Brain size={18} color="#2F6FED" />
            <span className="text-[#2F6FED] font-display font-bold text-[15px] uppercase tracking-wide">Mental Health</span>
          </motion.div>
          ...
          >
            Have You Tried
            <span className="text-[#2F6FED] block mt-2">Meditation for</span>
            <span className="text-[#10b981] block mt-1">Stress or Anxiety?</span>
          </motion.h2>
      ...
      >
        <div className="flex items-center gap-4 text-[#94a3b8] text-[20px] font-medium bg-[#0F172A]/90 px-6 py-4 rounded-xl backdrop-blur-sm border border-white/10 shadow-lg">
          ...
          <p className="leading-relaxed text-left">
            Source: Goyal M et al. (2014), JAMA Internal Medicine — Mindfulness meditation programs
          </p>
        </div>
      </motion.div>
    </motion.div>
