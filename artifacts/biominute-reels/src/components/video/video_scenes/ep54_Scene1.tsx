    ...
    <motion.div className="absolute inset-0 w-full h-full bg-[#0F172A] flex flex-col items-center justify-center overflow-hidden font-body"
      ...
      <div className="absolute top-[160px] flex flex-col items-center gap-5 z-10 w-full px-10">
        <motion.div className="bg-[#10b981]/10 border border-[#10b981]/30 px-8 py-4 rounded-2xl"
          ...
          <span className="text-[#10b981] font-display font-bold text-[22px] uppercase tracking-wider">Both Can Build Muscle</span>
        </motion.div>
        {[
          { icon: Dumbbell, color: '#f97316', title: 'Animal protein', body: 'Complete amino acid profile — high bioavailability' },
          { icon: Leaf, color: '#2F6FED', title: 'Plant protein', body: 'Combine sources (beans + grains) for full amino coverage' },
          { icon: Scale, color: '#10b981', title: 'Neither is universally superior', body: 'Total daily intake + variety is what drives results' },
        ].map((item, i) => {
