...
import { PersonStanding, Clock, Sparkles } from 'lucide-react';
    ...
    >
      ...
      <div className="absolute top-[240px] flex flex-col items-center z-10 w-full">
        <div className="relative w-[340px] h-[340px] flex items-center justify-center">
          ...
          >
            <PersonStanding size={88} color="#2F6FED" strokeWidth={1.5} />
          </motion.div>
        ...
        >
          <span className="text-[#f8fafc] font-display font-bold text-[22px] uppercase tracking-wider">Save Longer Static Stretches for After</span>
        </motion.div>
      </div>
