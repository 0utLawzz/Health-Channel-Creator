...
import { Heart, Leaf, Apple, Droplets } from 'lucide-react';
...
export function Scene3() {
  ...
  const icons = [
    { Icon: Apple, color: '#10b981', delay: 0.2, angle: 0 },
    { Icon: Leaf, color: '#2F6FED', delay: 0.5, angle: 120 },
    { Icon: Droplets, color: '#f97316', delay: 0.8, angle: 240 },
  ];
    ...
    >
      ...
      <div className="absolute top-[240px] flex flex-col items-center z-10 w-full">
        <div className="relative w-[340px] h-[340px] flex items-center justify-center">
          ...
          {icons.map(({ Icon, color, delay, angle }) => {
          ...
          >
            <Heart size={48} color="#0F172A" strokeWidth={2} />
          </motion.div>
        </div>
        ...
        >
          <span className="text-[#f8fafc] font-display font-bold text-[22px] uppercase tracking-wider">Overall Diet Quality Wins</span>
        </motion.div>
      </div>
      ...
      >
        ...
        >
          ...
          >
            Is the Overall Quality of Your Diet
          </motion.span>
        </motion.h2>
      </div>
    </motion.div>
