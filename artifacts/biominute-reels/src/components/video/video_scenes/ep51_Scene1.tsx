    ...
    <motion.div className="absolute inset-0 w-full h-full bg-[#0F172A] flex flex-col items-center justify-center overflow-hidden font-body"
      ...
      <div className="absolute top-[160px] flex flex-col items-center gap-5 z-10 w-full px-10">
        <motion.div className="bg-[#2F6FED]/10 border border-[#2F6FED]/30 px-8 py-4 rounded-2xl"
          ...
          <span className="text-[#2F6FED] font-display font-bold text-[22px] uppercase tracking-wider">What Daily Washing Does</span>
        </motion.div>
        {[
          { icon: Droplets, color: '#2F6FED', title: 'Cleans oil and buildup', body: 'Keeps your scalp healthy — this is all it does' },
          { icon: AlertTriangle, color: '#f97316', title: 'May look thinner temporarily', body: '50–100 strands shed daily is completely normal' },
          { icon: ShieldCheck, color: '#10b981', title: 'Does NOT damage follicles', body: 'Shampoo cannot trigger genetic hair loss' },
        ].map((item, i) => {
