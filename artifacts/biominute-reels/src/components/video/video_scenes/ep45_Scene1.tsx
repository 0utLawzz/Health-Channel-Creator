    ...
    <motion.div className="absolute inset-0 w-full h-full bg-[#0F172A] flex flex-col items-center justify-center overflow-hidden font-body"
      ...
      <div className="absolute top-[160px] flex flex-col items-center gap-5 z-10 w-full px-10">
        <motion.div className="bg-[#f97316]/10 border border-[#f97316]/30 px-8 py-4 rounded-2xl"
          ...
          <span className="text-[#f97316] font-display font-bold text-[22px] uppercase tracking-wider">Real-World Reality</span>
        </motion.div>
        {[
          { icon: AlertTriangle, color: '#f97316', title: 'Theory vs practice', body: 'In theory yes — but most people apply too little, too rarely' },
          { icon: Sun, color: '#14b8a6', title: 'UV still gets through', body: 'Small amounts reach skin during normal daily outdoor time' },
          { icon: Shield, color: '#10b981', title: 'Skin protection wins', body: 'Better tradeoff — get Vitamin D from food or supplements instead' },
        ].map((item, i) => {
