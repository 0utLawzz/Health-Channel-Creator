    ...
    >
      ...
      <div className="absolute top-[240px] z-10 w-[90%]">
        ...
        >
          ...
          >
            How Many Hours
            <span className="text-[#2F6FED] block mt-2">Do You Usually</span>
            <span className="text-[#f97316] block mt-2">Sleep?</span>
          </motion.h2>
          ...
          >
            ...
            <span className="text-[#94a3b8] text-[24px] font-medium">Drop your number 👇</span>
          </motion.div>
        </motion.div>
      </div>
      ...
      >
        <div className="flex items-center gap-4 text-[#94a3b8] text-[22px] font-medium bg-[#0F172A]/90 px-6 py-4 rounded-xl backdrop-blur-sm border border-white/10 shadow-lg">
          ...
          <p className="leading-relaxed text-left">
            Source: General sports science research on sleep and athletic recovery/performance (e.g. Fullagar HH et al. reviews)
          </p>
        </div>
      </motion.div>
    </motion.div>
