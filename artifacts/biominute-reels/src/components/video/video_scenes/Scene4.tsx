    ...
    >
      ...
      <div className="absolute top-[240px] z-10 w-[90%]">
        ...
        >
          ...
          >
            <Beef size={90} color="#10b981" strokeWidth={1.5} />
          </motion.div>
          ...
          >
            Which Meal Has
            <span className="text-[#f97316] block mt-2">The Most Protein</span>
            <span className="text-[#10b981] block mt-2">For You Right Now?</span>
          </motion.h2>
          ...
          >
            ...
            <span className="text-[#94a3b8] text-[24px] font-medium">Drop your answer below 👇</span>
          </motion.div>
        </motion.div>
      </div>
      ...
      >
        <div className="flex items-center gap-4 text-[#94a3b8] text-[22px] font-medium bg-[#0F172A]/90 px-6 py-4 rounded-xl backdrop-blur-sm border border-white/10 shadow-lg">
          ...
          <p className="leading-relaxed text-left">
            Source: Morton RW et al. (2018), American Journal of Clinical Nutrition
          </p>
        </div>
      </motion.div>
    </motion.div>
