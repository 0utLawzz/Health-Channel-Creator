...
import { Droplets, Salad, Dumbbell, Wine } from 'lucide-react';
...
export function Scene2() {
  ...
  const habits = [
    { icon: Droplets, label: 'Stay Hydrated', color: '#2F6FED' },
    { icon: Salad, label: 'Eat Fruits & Veg', color: '#10b981' },
    { icon: Dumbbell, label: 'Exercise Regularly', color: '#f97316' },
    { icon: Wine, label: 'Limit Alcohol', color: '#14b8a6' },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[185px] flex flex-col items-center gap-6 z-10 w-full px-10">
        ...
        >
          <span className="text-[#10b981] font-display font-bold text-[24px] uppercase tracking-wider">What Actually Helps</span>
        </motion.div>
          ...
          {habits.map((h, i) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-[#f8fafc] font-display font-bold text-[21px] uppercase text-center leading-tight">{h.label}</span>
              </motion.div>
            );
          })}
        </div>
        ...
        >
          <p className="text-[#f8fafc] font-display font-bold text-[26px] leading-snug uppercase tracking-wide">
            These Are the <span className="text-[#10b981]">Proven Ways</span> to Support Health
          </p>
        </motion.div>
      </div>
