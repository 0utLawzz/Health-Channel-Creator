    ...
    <motion.div className="absolute inset-0 w-full h-full bg-[#0F172A] flex flex-col items-center justify-center overflow-hidden font-body"
      ...
      <div className="absolute top-[110px] z-10 w-[90%] flex flex-col items-center gap-5">
        <motion.p className="text-[#94a3b8] font-display text-[24px] uppercase tracking-widest text-center"
          initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}>Raw vs Pasteurised</motion.p>
        ...
        <motion.div className="w-full bg-[#10b981]/10 border border-[#10b981]/30 rounded-[24px] p-5 flex items-center gap-5"
          ...
          <div className="flex-1">
            <p className="text-[#10b981] font-display font-bold text-[20px] uppercase">Calcium &amp; Protein</p>
            <p className="text-[#94a3b8] text-[17px]">Essentially identical in both — pasteurisation changes nothing</p>
          </div>
        </motion.div>
        ...
        <motion.div className="w-full bg-[#2F6FED]/10 border border-[#2F6FED]/30 rounded-[24px] p-5 flex items-center gap-5"
          ...
          <ShieldCheck size={44} color="#2F6FED" strokeWidth={1.4} className="shrink-0" />
          <div className="flex-1">
            <p className="text-[#2F6FED] font-display font-bold text-[20px] uppercase">Pasteurised</p>
            <p className="text-[#94a3b8] text-[17px]">Same nutrients — zero harmful bacteria</p>
          </div>
        </motion.div>
        ...
        <motion.div className="w-full bg-[#f97316]/10 border border-[#f97316]/30 rounded-[24px] p-5 flex items-center gap-5"
          ...
          <div className="flex-1">
            <p className="text-[#f97316] font-display font-bold text-[20px] uppercase">Raw Milk</p>
            <p className="text-[#94a3b8] text-[17px]">Same nutrients — real pathogen risk</p>
          </div>
        </motion.div>
        ...
        <motion.div className="bg-[#2F6FED]/10 border border-[#2F6FED]/30 rounded-2xl px-6 py-4 w-full text-center"
          ...
          <p className="text-[#2F6FED] font-display font-bold text-[20px] uppercase">The "healthier" label doesn't hold up</p>
        </motion.div>
      </div>
      <div className="absolute w-full px-12 text-center z-20" style={{ bottom: BOTTOM_SAFE_ZONE_PX + 60 }}>
        <motion.p className="text-[#64748b] font-body text-[18px]" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 2.8 }}>
          Source: CDC and FDA — comparative nutrient content and raw milk safety
        </motion.p>
      </div>
    </motion.div>
  );
