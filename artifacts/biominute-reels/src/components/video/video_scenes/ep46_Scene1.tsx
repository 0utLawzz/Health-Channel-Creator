    ...
    <motion.div className="absolute inset-0 w-full h-full bg-[#0F172A] flex flex-col items-center justify-center overflow-hidden font-body"
      ...
      <div className="absolute top-[160px] flex flex-col items-center gap-5 z-10 w-full px-10">
        <motion.div className="bg-[#f97316]/10 border border-[#f97316]/30 px-8 py-4 rounded-2xl"
          ...
          <span className="text-[#f97316] font-display font-bold text-[22px] uppercase tracking-wider">The Science</span>
        </motion.div>
        {[
          { icon: Flame, color: '#f97316', title: 'Slightly higher fat %', body: 'Fasted cardio burns more fat during the workout itself' },
          { icon: Clock, color: '#2F6FED', title: '24-hr total equals out', body: 'Over a full day, total fat loss is about the same either way' },
          { icon: Scale, color: '#10b981', title: 'Calorie balance rules', body: 'Your overall energy deficit matters most — not timing' },
        ].map((item, i) => {
