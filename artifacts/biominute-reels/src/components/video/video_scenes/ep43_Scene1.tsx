  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[160px] flex flex-col items-center gap-5 z-10 w-full px-10">
        ...
        {[
          { icon: Brain, color: '#2F6FED', title: 'Structured programs work', body: '8-week mindfulness programs show measurable anxiety reduction' },
          { icon: ShieldCheck, color: '#10b981', title: 'Comparable for mild–moderate', body: 'Effects rival some standard treatments in research studies' },
          { icon: Zap, color: '#f97316', title: 'Low-risk, accessible tool', body: 'No side effects — but severity and response vary significantly' },
        ].map((item, i) => {
