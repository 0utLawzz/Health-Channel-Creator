  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[160px] flex flex-col items-center gap-5 z-10 w-full px-10">
        ...
        {[
          { icon: Calendar, color: '#2F6FED', label: 'Consistency is key', body: '8+ weeks of regular practice — not one-off sessions' },
          { icon: CheckCircle2, color: '#10b981', label: 'Works best as a tool', body: 'Pairs well with therapy; doesn\'t replace medication for everyone' },
          { icon: AlertCircle, color: '#f97316', label: 'Severity matters', body: 'Severe anxiety often needs professional support first' },
        ].map((item, i) => {
      ...
      >
        ...
        >
          Worth
          <motion.span
            className="text-[#10b981] block mt-2"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
