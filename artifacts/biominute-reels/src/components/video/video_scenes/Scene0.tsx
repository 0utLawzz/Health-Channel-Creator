  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[260px] flex items-center justify-center z-10 w-full">
        ...
        >
          <Sun size={140} color="#f97316" strokeWidth={1.5} fill="#f97316" fillOpacity={0.2} />
          <motion.div
            className="absolute -bottom-4 -right-4 w-20 h-20 rounded-full bg-[#2F6FED] flex items-center justify-center"
            initial={{ scale: 0, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            transition={{ delay: 0.8, ...SPRING_SNAPPY }}
          >
            <Moon size={40} color="#0F172A" strokeWidth={2} />
          </motion.div>
        </motion.div>
      </div>
