...
export function Scene0() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute top-[20%] w-[550px] h-[550px] bg-gradient-to-tr from-[#f97316]/20 to-[#10b981]/10 rounded-full blur-[120px]"
      ...
      <div className="absolute top-[260px] flex items-center justify-center z-10 w-full">
        ...
        >
          <Utensils size={140} color="#f97316" strokeWidth={1.5} />
          <motion.div
